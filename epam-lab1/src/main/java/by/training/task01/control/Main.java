        ...
        while(isRunning) {
            ...
            switch (next) {
                ...
                case 2 : {
                    ...
                    System.out.println("Мера угла в градусах = " + Task2.getDegrees(radians));
                    System.out.println("Мера угла в минутах = " + Task2.getMinutes(radians));
                    System.out.println("Мера угла в секундах = " + Task2.getSeconds(radians));
                    break;
                }
                case 3 : {
